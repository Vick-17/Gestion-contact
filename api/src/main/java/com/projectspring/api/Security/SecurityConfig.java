...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager)
        ...
        // Le code suivant permet de modifier la chaîne de filtres 
        ...
        http.csrf(csrf -> csrf.disable()) // désactivation de la vérification par défaut des attaques CSRF (pas grave vue qu'on va mettre en place un système de jetons)
                ...
                .authorizeHttpRequests((authz) -> authz
                        ...
                        .requestMatchers(HttpMethod.POST, authorized).permitAll()
                        .requestMatchers(HttpMethod.PUT, authorized).permitAll()
                        .requestMatchers(HttpMethod.DELETE, authorized).permitAll()
                        .requestMatchers(HttpMethod.GET, authorized_for_admin).hasRole("ADMIN")
